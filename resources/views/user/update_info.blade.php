...
@section('content')
    ...
    <div class="container">
        <div class="row m-5 no-gutters shadow-lg">
            ...
            <div class="col-md-6 bg-white p-5">
                <h3 class="pb-3">Cập nhật thông tin</h3>
                <div class="form-style">
                    ...
                    <form action="{{route('update_info')}}" method="POST">
                        ...
                        <div class="pb-2">
                            <button type="button" id="btn-sign-in-update" class="btn btn-dark w-100 font-weight-bold mt-2">Cập nhật</button>
                        </div>
                    </form>
                </div>
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click', '#btn-sign-in-update', function(e){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if($.isEmptyObject(data.error)){
                            Swal.fire({
                                title: 'Thành Công!',
                                text: 'Cập nhật thông tin đã thành công!',
                                icon: 'success',
